    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even a single paragraph is enough. <span class=”highlight-bold”>MiroFish</span> extracts seeds of reality from it and automatically generates a parallel world of up to <span class=”highlight-orange”>1 million Agents</span>. Inject variables from a god's-eye view and search for a <span class=”highlight-code”>”local optimum”</span> amid complex collective dynamics.
            </p>
            <p class=”slogan-text”>
              Let the future rehearse in an Agent swarm. Let decisions emerge battle-tested.<span class=”blinking-cursor”>_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby — upload documents to initialize a simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & persona generation & agent injection with simulation params</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsed prediction needs & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
        ...
        <div class="right-panel">
          <div class="console-box">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., 'If the Fed announces a rate cut, what market sentiment follows?')"
                  rows="6"
                  :disabled="loading"
                ></textarea>
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">>_ 03 / Kalshi Market Question (optional)</span>
              </div>
              <div class="input-wrapper">
                <input
